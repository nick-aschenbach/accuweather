...
describe Accuweather::Location do
  subject { Accuweather::Location.new(id: 'cityId:53286',
                                      city: 'Vancouver',
  ...
  describe '#==' do
    context 'with two objects with the same attributes' do
      it 'returns true' do
        expect(subject).to eq(Accuweather::Location.new(id: 'cityId:53286',
                                                        city: 'Vancouver',
                                                        state: 'Canada (British Columbia)',
                                                        latitude: '49.2448',
                                                        longitude: '-123.1154'))
    ...
    context 'with two objects that vary' do
      it 'returns false' do
        expect(subject).to_not eq(Accuweather::Location.new(id: 'cityId:53286',
                                                            city: 'Not Vancouver',
                                                            state: 'Canada (British Columbia)',
                                                            latitude: '49.2448',
                                                            longitude: '-123.1154'))
